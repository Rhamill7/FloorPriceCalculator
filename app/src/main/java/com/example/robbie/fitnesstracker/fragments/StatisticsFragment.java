...
import com.example.robbie.fitnesstracker.helpers.MyXAxisValueFormatter;
...
public class StatisticsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("FitnessTracker - Statistics");
